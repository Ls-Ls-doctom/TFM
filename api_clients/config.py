...
# --- Profundidad historica de extraccion ---
INE_NULT = int(os.getenv("ISEU_INE_NULT", "9999"))
BCN_DATASTORE_PAGE_SIZE = int(os.getenv("ISEU_BCN_PAGE_SIZE", "5000"))
BCN_DATASTORE_MAX_RECORDS = int(os.getenv("ISEU_BCN_MAX_RECORDS", "100000"))
REE_START_DATE = os.getenv("ISEU_REE_START_DATE", "2024-01-01")
REE_END_DATE = os.getenv("ISEU_REE_END_DATE", "")
SEPE_MAX_MONTHS = int(os.getenv("ISEU_SEPE_MAX_MONTHS", "12"))
